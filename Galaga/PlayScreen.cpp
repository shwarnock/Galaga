...
PlayScreen::PlayScreen()
{
	...
	mStartLabel->Pos(Vector2(Graphics::Instance()->SCREEN_WIDTH * 0.38f, Graphics::Instance()->SCREEN_HEIGHT * 0.5f));
...
void PlayScreen::StartNewGame()
{
	...
	mPlayer->Pos(Vector2(Graphics::SCREEN_WIDTH * 0.37f, Graphics::Instance()->SCREEN_HEIGHT * 0.9f));
	...
	mLevelStarted = false;
	mLevelStartTimer = 0.0f;
	mAudio->PlayMusic("GalagaStartScreenMusic.wav", 0);
}
